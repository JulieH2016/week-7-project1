...
function grabThumbnails (locationClick){
	...
	var apiUrl = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=' + apiKey + '&tags=' + userInput + '&privacy_filter=1&safe_search=1&content_type=1&lat=' + globalPOILatitude +'&lon='+ globalPOILongitude +'&extras=url_q%2C+url_z&per_page=100&format=json&nojsoncallback=1';
